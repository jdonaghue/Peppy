...
test("id", function() {
	...
	isSet( peppy.query("div#form", document.body), [], "ID selector within the context of another element" );
});
...
test("name", function() {
	...
	isSet( peppy.query("input[name=action]", document.getElementById("form")), q("text1"), "Name selector within the context of another element" );
	isSet( peppy.query("input[name='foo[bar]']", document.getElementById("form")), q("hidden2"), "Name selector for grouped form element within the context of another element" );
});
